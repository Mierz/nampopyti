			 ...
			 <?php
				...
				foreach($routes as $item)	{
					if(date('Y-m-d') <= $item['date']) {
						if($item['photo'] != null) {
							$photo = '<img src="'.$item['photo'].'" class="img-rounded" style="width:100px;height:100px;border:1px solid #ddd;">';
						} else {
							$photo = '<img src="/img/no_photo.png" class="img-rounded" style="width:100px;height:100px;border:1px solid #ddd;">';
						}
						echo '<tr><td><div style="float:left;width:105px;"><a href="/user/profile/'.$item['author'].'" title="Перейти на профиль пользователя">'.$photo.'</a></div>
						...
						<div style="float:left;width:70%;">
										...
										<p style="margin:5px;"><b>Дата отправления:</b> '.$item['date'].'</p>
									</div>	
						</td></tr>';				
					}
			} }
