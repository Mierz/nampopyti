...
<head>
	<meta charset="utf-8">
	<title>Активация аккаунта - Нам по пути</title>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="alert alert-success">
			  <strong>Успех!</strong> Ваш аккаунт успешно активирован. Теперь вы можете войти на сайт используя свою почту и пароль!
			</div>
		</div>
	</div>
