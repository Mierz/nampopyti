...
<head>
	<meta charset="utf-8">
	<title>Новый пароль - <?=$this->lang->line('title')?></title>
...
<div class="container test_main">
	...
	<div class="row-fluid" style="padding-top:20px;">
		<div class="span12">
			<p>Теперь вы можете указать новый пароль</p>
			<form action="/user/lostpassword/<?=$code?>" id="new-pass" method="post">
			  <div class="control-group">
				<label class="control-label" for="pass">Пароль</label>
				<div class="controls">
					<input type="password" name="pass" id="pass" maxlength="30" placeholder="Пароль" validate="required" />
				</div>
			  </div>	
			<div class="control-group">
				<label class="control-label" for="pass2">Повторите пароль</label>
				<div class="controls">
					<input type="password" name="pass2" id="pass2" maxlength="30" placeholder="Повторите пароль" validate="custom_pass_eq|required" />
				</div>
			  </div>				  
			  <div class="control-group">
				<div class="controls">				  
